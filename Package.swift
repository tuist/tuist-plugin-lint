...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/tuist/tuist", revision: "d935cfb0a13035af138fda17a628ba69649ae265"), // TODO: replace "revision" with requirement for released version when `3.0` be released
