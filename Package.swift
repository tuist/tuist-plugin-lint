...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/tuist/tuist", revision: "b29e347ea9ce7dab357681ae85632690e745e5be"), // TODO: replace "revision" with requirement for released version when `3.0` be released
